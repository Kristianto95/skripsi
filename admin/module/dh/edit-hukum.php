<div class="container-fluid">
  ...
  <br>
        <?php
           $id = $_GET['id'];
          foreach ($db->tampil_hukum($id) as $row){
        ?>
    <form method="post"  name="formDasarHukum" id="register-form" onSubmit="return alert('Data Telah Diubah')" action="../application/controller/controller_admin.php?aksi=update_hukum" >
    <br>
        <div class="form-body">
