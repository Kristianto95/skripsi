...
<div class="container-fluid kotak5">
  ...
  <br>
    <form method="post"  name="formPersyaratan"  action="../application/controller/controller_admin.php?aksi=tambah_persyaratan" >
    <br>
        <div class="form-body">
            <div class="form-group">
             ...
             <div class="form-group col-sm-12">
                   ...
                   <div class="input-group-addon"><span class="glyphicon glyphicon-paperclip"></span></div>
                    <textarea name="isi" type="text" class="form-control" placeholder="Isikan Persyaratan" ></textarea>
                   </div>
              </div>  
