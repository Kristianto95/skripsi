        <h3 class="text-center "><img src="../application/gambar/kabupaten.png" width="8%" height="8%">Tanda Bukti Pengajuan IMB</h3>
        <br>
        <br>
                  ...
                  <table >
                    ...
                    ?>
                            ...
                            <tr>
                                ...
                                <td style="vertical-align: top; padding-left:20px;">:</td>
                                <td style="padding-left:20px;"><?php echo $row['nama']; ?></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top;">Alamat</td>
                                <td style="vertical-align: top; padding-left:20px;">:</td>
                                <td style="padding-left:20px;"><?php echo $row['alamat'];?></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top;">Maksud Permohonan IMB</td>
                                <td style="vertical-align: top;padding-left:20px;">:</td>
                                <td style="padding-left:20px;"><?php echo $row['maksud'];?></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top;">Penggunaan Bangunan</td>
                                <td style="vertical-align: top; padding-left:20px;">:</td>
                                <td style="padding-left:20px;"><?php echo $row['penggunaan']; ?></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top;">Alamat Lokasi Bangunan</td>
                                <td style="vertical-align: top; padding-left:20px;">:</td>
                                <td style="padding-left:20px;"><?php echo $row['lokasi']; ?></td>
                            </tr>
                             <tr>
                                <td style="vertical-align: top;">Luas Tanah</td>
                                <td style="vertical-align: top; padding-left:20px;">:</td>
                                <td style="padding-left:20px;"><?php echo $row['luastanah']; ?> m<sup>2</sup></td>
                            </tr>
                             <tr>
                                <td style="vertical-align: top;">Luas Bangunan</td>
                                <td style="vertical-align: top; padding-left:20px;">:</td>
                                <td style="padding-left:20px;"><?php echo $row['luasbangunan']; ?> m<sup>2</sup></td>
                            </tr>
                            <tr>
                                <td style="vertical-align: top;">Status Tanah</td>
                                <td style="vertical-align: top; padding-left:20px;">:</td>
                                <td style="padding-left:20px;"><?php echo $row['status']; ?></td>
                            </tr>
                            <?php
                                }
                            ?>
